...
const shadowStyles = tag('style', 'p { color: red; }')

// Create form inputs
const NameInput = tag('input', { type: 'text', placeholder: 'Your name...' })
// Use on to create event listeners
const ShowNameButton = FormButton(
    'Greet',
    on('click', () => alert('Hello, ' + NameInput.value)),
)
...
const Doc = [
    ...
    tag('form', NameInput, ShowNameButton),

    h2('Using the Shadow DOM'),
    p('I am in no way related to a shadow!'),
    tag(
        'span', // The parent of the shadow
